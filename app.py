...
# Código HTML completo (exatamente como você mandou)
html_code = """
...
def cadastrar():
    ...
    # Você pode salvar no banco aqui se quiser
    ...
    """
    return render_template_string(html_code + script)
