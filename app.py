...
DB_CONFIG = {
    'host': 'os.environ.get('bubbledatabase.mysql.database.azure.com')', 
    'port': int(os.environ.get('DB_PORT', 3306)),
    'database': os.environ.get('bubbledatabase'),
    'user': os.environ.get('bolha'), 
    'password': os.environ.get('bubble@2025'),
    'charset': 'utf8mb4',
